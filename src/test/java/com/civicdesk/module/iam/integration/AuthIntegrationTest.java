...
class AuthIntegrationTest {
    ...
    void registerThenLoginThenAccessProtectedEndpoint() throws Exception {
        ...
        String loginBody = mockMvc.perform(post("/auth/citizen/login")
                        .contentType(MediaType.APPLICATION_JSON)
    ...
    void adminCreatedStaff_mustSetPasswordBeforeLogin() throws Exception {
        String adminToken = JsonPath.read(mockMvc.perform(post("/auth/staff/login")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(om.writeValueAsString(Map.of(
        ...
        mockMvc.perform(post("/auth/setPassword")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(om.writeValueAsString(Map.of(
